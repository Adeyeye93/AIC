defmodule YedeiWeb.Settings.Settings do
  ...
  def update(%{"token" => token} = assigns, socket) do
    socket =
      case Account.update_user_email(assigns.current_user, token) do
        :ok ->
    ...
    {:ok, push_navigate(socket, to: ~p"/users/settings") |> assign(assigns)}
  end
